...
//in case of iOS --- see below
  ...
  void showNotification(message) async{
    var androidPlatformChannelSpecifics=new AndroidNotificationDetails(
        Platform.isAndroid?"com.insideoyo.inside_oyo":"com.insideoyo.inside_oyo",
        'Inside Oyo',
        'Inside Oyo Notification',
        playSound: true,
    ...
    await flutterLocalNotificationsPlugin.show(
        0, message['notification']['title'].toString()=='null'?"Inside Oyo":message['notification']['title'].toString(), message['notification']['body'].toString(), platformChannelSpecifics,
